...
class TenPersonGameViewController: UIViewController {
    ...
    //outlets to labels to add pictures of balls and initials upon loading
    ...
    override func viewDidLoad() {
        ...
        chairArr = [chair0Button, chair1Button, chair2Button, chair3Button, chair4Button, chair5Button, chair6Button, chair7Button, chair8Button, chair9Button]
